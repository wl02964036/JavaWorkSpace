...
<jsp:useBean id="m" class="tw.iiihealth.meals.MealBean" scope="session" />
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<div class="card-header">
				...
				<h3>刪除餐點資料如下請確認：</h3>
				<form action="deleteConfirm.controller" method="post">
					<br>餐點名稱：<jsp:getProperty name="m" property="name" /><br>
					<br>價格($NT)： ${m.price} <br> <br>主原料：${m.material}<br>
					<br>熱量(kcal)：${m.calories} <br> <br>蛋白質(g)：${m.protein}
					<br> <br>碳水化合物(g)：${m.carbohydrates} <br> <br>脂肪(g)：${m.fat}
					<br> <br>商店編號：${m.store_ID}<br> <br> <input
						type="submit" name="dconfirm" value="確認刪除">
				</form>
			</div>
			</main>
		</div>
