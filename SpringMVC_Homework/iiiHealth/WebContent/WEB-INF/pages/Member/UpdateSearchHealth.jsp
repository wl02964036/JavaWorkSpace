				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-6">
									<form action="displayUpdateSearchHealth" method="post"
										id="form1" onsubmit="return checkSubBtn();">
										<table class="table  table-hover">
											<tr>
												<td>員工編號:</td>
												<td><input type="text" name="empno" id="empno"
													maxlength="10" size="15" value="${empno}" readonly><span
													style="color: red;">(不可更改)</span></td>
											</tr>
											<tr>
												<td>員工姓名:</td>
												<td><input type="text" id="ename1" name="ename"
													size="10" placeholder="例如:王衍申" autocomplete="off"
													value="${ename}"> <span id="enameCheck"></span></td>
											</tr>
											<tr>
												<td>性別:<input type="hidden" value="${gender}"></td>
												<td><input type="radio" name="gender" id="sex1"
													value="male"
													<%if (request.getParameter("gender").equals("male")) {
	out.print(" checked");
}%>>男
													<input type="radio" name="gender" id="sex2" value="female"
													<%if (request.getParameter("gender").equals("female")) {
	out.print(" checked");
}%>>女
													<input type="radio" name="gender" id="sex3" value="other"
													<%if (request.getParameter("gender").equals("other")) {
	out.print(" checked");
}%>>其他
											...
											<tr>
												...
												<td><input type="text" name="rocid1" id="rocid1"
													...
													value="${rocid1}"> <span id="rocidCheck"></span></td>
											</tr>
											<tr>
												<td>生日日期:</td>
												<td>民國 <input class="in" type="text" name="year1"
													id="year1" maxlength="3" size="3" value="${year1}">
													年 <input class="in" type="text" name="month1" id="month1"
													maxlength="2" size="2" value="${month1}"> 月 <input
													class="in" type="text" name="day1" id="day1" maxlength="2"
													size="2" value="${day1}"> 日 <span id="birthCheck"></span></td>
											</tr>
											<tr>
												<td>公司名稱:</td>
												<td><input type="text" id="cname1" name="cname1"
													size="25" placeholder="例如:楊泰企業股份有限公司" value="${cname1}">
													<span id="cnameCheck"></span></td>
											</tr>
											<tr>
												<td>帳號:</td>
												<td><input type="text" id="account1" name="account1"
													size="15" value="${account1}"> <span id="acntCheck"></span></td>
											</tr>
											<tr>
												<td>密碼:</td>
												<td><input type="password" id="pwd1" name="pwd1"
													maxlength="15" size="15" value="${pwd1}"> <span
											...
											<tr>
												...
												<td><input type="password" id="pwd2" name="pwd2"
													maxlength="15" size="15" value="${pwd2}"> <span
													id="pwd2Check"></span></td>
											</tr>
											<tr>
												<td>信箱:</td>
												<td><input type="text" name="email1" id="email1"
													size="15" placeholder="aaa@gmail.com" value="${email1}">
											...
											<tr>
												...
												<td>( <input class="addr" type="text" name="phone1"
													...
													value="${phone1}"> ) <input type="text"
													name="phone2" id="phone2" maxlength="8" size="10"
													placeholder="66316666" value="${phone2}"> <span
													id="phoneCheck"></span></td>
											</tr>
											<tr>
												<td>公司縣市:<input type="hidden" value="${addr1}"></td>
												<td><select name="addr1" id="addr1">
														<option value="" style="color: lightgray;">--未選擇--</option>
														<optgroup label="北部">
															<%
																ArrayList<String> addrList1 = new ArrayList<String>(Arrays.asList("基隆市", "新北市", "台北市", "桃園市", "新竹縣", "新竹市", "宜蘭縣"));

															for (int i = 0; i < addrList1.size(); i++) {
																out.print("<option");
																if (request.getParameter("addr1").equals(addrList1.get(i))) {
																	out.print(" selected");
																}
																out.print(">" + addrList1.get(i) + "</option>");
															}
															%>
														</optgroup>
														<optgroup label="中部">
															<%
																ArrayList<String> addrList2 = new ArrayList<String>(Arrays.asList("苗栗市", "臺中市", "彰化縣", "彰化市", "南投市", "南投縣", "雲林縣"));
														...
														<optgroup label="南部">
															<%
																ArrayList<String> addrList3 = new ArrayList<String>(Arrays.asList("嘉義縣", "嘉義市", "臺南市", "高雄市", "屏東縣", "屏東市"));
														...
														<optgroup label="東部">
															<%
																ArrayList<String> addrList4 = new ArrayList<String>(Arrays.asList("花蓮縣", "花蓮市", "臺東市", "臺東縣"));
														...
														<optgroup label="離島">
															<%
																ArrayList<String> addrList5 = new ArrayList<String>(Arrays.asList("澎湖縣", "綠島", "蘭嶼", "金門縣", "馬祖", "連江縣"));
											...
											<tr>
												...
												<td>( <input class="addr" type="text" name="addr2"
													id="addr2" size="5" placeholder="106" value="${addr2}">
													)<span id="addr2Check"></span></td>
											</tr>
											<tr>
												<td>公司地址:</td>
												<td><input type="text" name="addr3" id="addr3"
													size="20" placeholder="台北市大安區復興南路一段390號2樓" value="${addr3}">
													<span id="addr3Check"></span></td>
											</tr>
											<tr>
											...
											<tr>
												<td><input type="submit" class="btn" id="subBtn"
													name="updateSearchHealth" value="送出"></td>
