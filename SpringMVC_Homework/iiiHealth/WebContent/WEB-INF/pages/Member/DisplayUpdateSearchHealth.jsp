							...
							<div class="row">
								...
								<div class="col-md-6">
									<table class="table  table-hover">
										...
										<tr>
											<td>
												<form action="updateHealthAction.controller" method="post">
													...
													<input type="hidden" name="pwd1" value="${pwd1}"> <input
														...
														type="submit" name="displayUpdateSearchHealth" value="確認">
												</form>
											</td>
											<td>
												<form action="reUpdateSearchHealth" method="post">
													<input type="hidden" name="empno" value="${empno}">
													<input type="hidden" name="ename" value="${ename}">
													<input type="hidden" name="gender" value="${gender}">
													<input type="hidden" name="rocid1" value="${rocid1}">
													...
													<input type="hidden" name="pwd1" value="${pwd1}"> <input
														...
														type="hidden" name="addr2" value="${addr2}"> <input
														type="hidden" name="addr3" value="${addr3}"> <input
														type="submit" name="displayUpdateSearchHealth"
														value="返回上一頁">
												</form>
											</td>
										</tr>
