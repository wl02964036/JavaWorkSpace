								...
								<c:forEach items="${listDrugs}" var="Drug">
									<tr>
											...
											<tr>
												<td>許可證字號</td>
												<td>${Drug.cnumber}</td>
												<td><input type="hidden" name="cnumber"
													value="${Drug.cnumber}"></td>
											</tr>
											<tr>
												<td>中文藥名</td>
												<td>${Drug.chinesename}</td>
												<td><input type="hidden" name="chinesename"
													value="${Drug.chinesename}"></td>
											</tr>
											<tr>
												<td>英文藥名</td>
												<td>${Drug.englishname}</td>
												<td><input type="hidden" name="englishname"
													value="${Drug.englishname}"></td>
											</tr>
											<tr>
												<td>申請商</td>
												<td>${Drug.applicant}</td>
												<td><input type="hidden" name="applicant"
													value="${Drug.applicant}"></td>
											</tr>
											<tr>
												<td>形狀</td>
												<td>${Drug.shape}</td>
												<td><input type="hidden" name="shape"
													value="${Drug.shape}"></td>
											</tr>
											<tr>
												<td>顏色</td>
											...
											<tr>
												...
												<td><input type="hidden" name="appearance"
													value="${Drug.appearance}"></td>
											</tr>
											<tr>
												<td>修改</td>
												<td><a href="<c:url value='update'/>"></a></td>
												
											</tr>
											<tr>
												<td>刪除</td>
												<td><a href="<c:url value='/remove/${Drug.id}' />"></a></td>
											</tr>
