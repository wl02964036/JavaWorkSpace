	...
	<div id="layoutSidenav">
				...
				<div class="nav">
					...
					<div class="collapse" id="collapseLayouts1"
						...
						<nav class="sb-sidenav-menu-nested nav"> <a class="nav-link"
							href="../Taxi/taxisystemEntry.controller">計程車資訊</a> <a class="nav-link"
							href="../Taxi/locsystemEntry.controller">店家資訊</a> </nav>
					</div>
					...
					<div class="collapse" id="collapseLayouts4"
						aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
						<nav class="sb-sidenav-menu-nested nav"> <a class="nav-link"
							href="../Drugs/Drugs">藥品辨識系統</a> <a class="nav-link" href="../Drugs/DrugsProduct">藥品包裝變更</a>
		...
		<div id="layoutSidenav_content">
			...
			<div class="card-header">
				...
				<form action="dietViewType.controller" method="get">
					<input type="hidden" name="h" /> 
					<input type="submit" name="bsubmit" value="穀物類" onclick="h.value=this.value" /> 
					<input type="submit" name="bsubmit" value="澱粉類" onclick="h.value=this.value" /> 
					<input type="submit" name="bsubmit" value="堅果及種子類" onclick="h.value=this.value" />
					<input type="submit" name="bsubmit" value="水果類" onclick="h.value=this.value" /><br>
					<input type="submit" name="bsubmit" value="蔬菜類" onclick="h.value=this.value" />
				    <input type="submit" name="bsubmit" value="藻類"	onclick="h.value=this.value" /> 
				    <input type="submit" name="bsubmit" value="菇類" onclick="h.value=this.value" />
					<input type="submit" name="bsubmit" value="豆類" onclick="h.value=this.value" /> 
					<input type="submit" name="bsubmit" value="肉類" onclick="h.value=this.value" />
					<!--         <input type="submit" name="bsubmit" value="魚貝類" onclick="h.value=this.value"> -->
					<!--         <input type="submit" name="bsubmit" value="蛋類" onclick="h.value=this.value"> -->
					<!--         <input type="submit" name="bsubmit" value="乳品類" onclick="h.value=this.value"> -->
					<!--         <input type="submit" name="bsubmit" value="油脂類" onclick="h.value=this.value"> -->
					<!--         <input type="submit" name="bsubmit" value="糖類" onclick="h.value=this.value"> -->
					<!--         <input type="submit" name="bsubmit" value="飲料類" onclick="h.value=this.value"><br> -->
					<!--         <input type="submit" name="bsubmit" value="乳品類" onclick="h.value=this.value"> -->
					<!--         <input type="submit" name="bsubmit" value="調味料及香辛料類" onclick="h.value=this.value"> -->
					<!--         <input type="submit" name="bsubmit" value="糕餅點心類" onclick="h.value=this.value"> -->
