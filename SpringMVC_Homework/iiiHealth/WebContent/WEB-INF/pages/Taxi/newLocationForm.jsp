				...
				<div class="card mb-4">
					<div class="card-header">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<h2 style="text-align: center">請填寫註冊資料</h2>
								<div class="card-body">
									<form:form id="newLoc" method="POST"
										action="newLocationCheck.controller"
										modelAttribute="addlocation">
										<table class="table  table-hover">
											<tr>
												<td><form:label path="lName">店家名稱:</form:label></td>
												<td><form:input path="lName" onblur="Onblur(this,sp1)" autofocus="autofocus"/></td>
											...
											<tr>
												...
												<td><form:radiobutton path="healthInsurance" value="Yes" label="是" /> 
													<form:radiobutton path="healthInsurance" value="No" label="否" /></td>
											</tr>
											<tr>
												<td><form:label path="phoneNum">電話:</form:label></td>
												<td><form:input path="phoneNum" onblur="Onblur(this,sp3)"/></td>
											...
											<tr>
												<td><input type="button" onclick="CheckandSub()" value="送出" /></td>
...
<script
	...
	function CheckandSub(){
		let flag1= Onblur(document.getElementById("lName"),sp1);
