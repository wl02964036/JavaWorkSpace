			...
			<main>
				<div class="card mb-4">
					<div class="card-header">
						...
						<div class="row">
							<div class="col-md-6">
								<h2 style="text-align: center">登記資料如下請確認</h2>
								<div class="card-body">

									<form action="addLocation.controller" method="post">
										<table id="datatablesSimple">
											<tr>
												<td>店家名稱</td>
												<td>${locCheck.lName}</td>
												<td><input type="hidden" name="lName"
													value="${locCheck.lName}"></td>
											</tr>
											<tr>
												<td>類別</td>
												<td>${locCheck.type}</td>
											...
											<tr>
												<td>是否為健保特約店家</td>
												<td>${locCheck.healthInsurance}</td>
												<td><input type="hidden" name="healthInsurance"
													value="${locCheck.healthInsurance}"></td>
											</tr>
											<tr>
												<td>電話</td>
												<td>${locCheck.phoneNum}</td>
												<td><input type="hidden" name="phoneNum"
													value="${locCheck.phoneNum}"></td>
											</tr>
											<tr>
												<td>營業時間</td>
												<td>${locCheck.time}</td>
											...
											<tr>
												<td>店休日</td>
												<td>${locCheck.closeDay}</td>
												<td><input type="hidden" name="closeDay"
													value="${locCheck.closeDay}"></td>
											</tr>
											<tr>
												<td>縣市</td>
												<td>${locCheck.city}</td>
											...
											<tr>
												<td>網站</td>
												<td>${locCheck.siting}</td>
												<td><input type="hidden" name="siting"
													value="${locCheck.siting}"></td>
											</tr>
										</table>
										<div class="sub">
