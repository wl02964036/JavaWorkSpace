			...
			<main>
				<div class="card mb-4">
					<div class="card-header">
						...
						<div class="card-body">
							<form id="sub" action="taxinew.controller" method="post">
								...
								<tbody>
									...
									<c:forEach var="taxi" items="${listTaxi}">
										<tr>
											...
											<td>${taxi.careTaxi}</td>
											<td>
												<form action="taxiupdateold.controller" method="post">
													<input type="hidden" name="id" value="${taxi.id}">
													<input type="hidden" name="tname" value="${taxi.tname}">
													<input type="hidden" name="phone" value="${taxi.phone}">
													<input type="hidden" name="address" value="${taxi.address}">
													<input type="hidden" name="serCity" value="${taxi.serCity}">
													<input type="hidden" name="CareTaxi" value="${taxi.careTaxi}"> 
													<input type="submit" class="btn" name="update" value="修改">
												</form>
											</td>
											<td>

												<form id="delT${taxi.id}" action="taxidelete.controller"
													method="post">
