					...
					<div class="card-header">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<form:form method="POST" action="updateLocation.controller"
									...
									<table id="datatablesSimple">
										<tbody>
											...
											<tr>
												...
												<td>${updatelocation.healthInsurance}</td>
												<td><form:hidden path="healthInsurance" /></td>
											</tr>
											<tr>
												<td>電話</td>
												<td>${updatelocation.phoneNum}</td>
												<td><form:hidden path="phoneNum" /></td>
											</tr>
											<tr>
												<td>營業時間</td>
											...
											<tr>
												<td>店休日</td>
												<td>${updatelocation.closeDay}</td>
												<td><form:hidden path="closeDay" /></td>
											</tr>
											<tr>
												<td>縣市</td>
											...
											<tr>
												<td>網站</td>
												<td>${updatelocation.siting}</td>
												<td><form:hidden path="siting" /></td>
											</tr>
										</tbody>
									</table>
									<div class="sub">
										<input type="submit" name="updateLoc" value="更新">
