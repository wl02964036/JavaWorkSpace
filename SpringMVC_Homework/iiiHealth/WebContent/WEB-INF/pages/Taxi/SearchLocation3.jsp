			...
			<main>
				<div class="card mb-4">
					...
					<div class="card-body">
						...
						<form id="sub" action="locationnew.controller" method="get">
							<input type="hidden" name="newLoc">
						</form>
							...
							<tbody>
								<c:forEach var="loc" items="${listLoc}">
									<tr>
										...
										<td>${loc.siting}</td>
										<td>
											<form action="updatelocold.controller" method="post">
												<input type="hidden" name="id" value="${loc.id}"> <input
													type="submit" class="btn" name="update" value="修改">
											</form>
										</td>
										<td>
											<form id="delT${loc.id}" action="deleteloc.controller"
												method="post">
												<input type="hidden" name="delete"> <input
													type="button" class="btn" onclick="check(${loc.id})"
													value="刪除"> <input type="hidden" name="selected"
													value="${loc.id}">
											</form>
										</td>
									</tr>
