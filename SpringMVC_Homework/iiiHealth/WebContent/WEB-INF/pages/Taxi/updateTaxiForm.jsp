				...
				<div class="card mb-4">
					<div class="card-header">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<form id="sub" action="taxiupdatecheck.controller" method="post">
									<input type="hidden" name="updateCheck">
									<table class="table  table-hover">
									<tr>
										<td>編號:</td>
										<td> ${oldTaxi.id} </td>
										<td><input type="hidden" name="id_num"
											value="${oldTaxi.id}"></td>
									</tr>
									<tr>
...
<%-- 										<td><input type="hidden" value="${oldTaxi.serCity}" /></td>  --%>
										<td><input type="text" id="serCity" name="serCity" value="${oldTaxi.serCity}"></td>
											<%-- 			<% --%>
											<!-- // 				for (int i = 0; i < testCityDB.size(); ++i) { -->
											<!-- // 					out.println("<label>"); -->
											<!-- // 					out.println("<input type='checkbox' name='serCity' value='" + testCityDB.getCityName(i) +"'"); -->
											<!-- // 					if (request.getParameter("serCity").contains(testCityDB.getCityName(i))) { -->
											<!-- // 					out.print(" checked"); } -->
											<!-- // 					out.print(">"); -->
...
<%-- 										<td><input type="hidden" value="${oldTaxi.careTaxi}" /></td>  --%>
										<td><label>
									...
									<tr>
										<td><input type="button" onclick="CheckandSub()" value="更新"></td>
										<td><input type="button" onclick="history.back()" value="取消"></td>
									</tr>
									</table>
								</form>
							</div>
		...
		<script>
			...
			function CheckandSub() {
				...
				let flag2 = phoneCheck(document.getElementById("phoneNum"), sp2);
