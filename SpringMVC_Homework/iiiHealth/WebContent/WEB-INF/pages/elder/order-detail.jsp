				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
								...
								<tbody>
									<c:forEach var="detail" items="${order.orderDetail}">
										...
										<c:url var="delete" value="delete">
											...
											<c:param name="detailId" value="${detail.id}"></c:param>
										</c:url>
										...
										<tr>
											...
											<td>${detail.total}</td>
											<th><a href="${delete}"><img src="${pageContext.request.contextPath}/resources/images/delete.png"/></a><th>
										</tr>
									</c:forEach>
								</tbody>
							</table>
							...
							<p>
								<a href="${pageContext.request.contextPath}/order/list">返回主頁</a>
							</p>
