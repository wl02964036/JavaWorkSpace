...
//			
//			String sql = "SELECT * FROM MemberHLab01 where id = ?";
//			try (
...
//			DataSource ds = (DataSource) context.lookup(resource);
//			
//			String sql = "INSERT INTO MemberHLab01 (id, pswd, name) VALUES(?, ?, ?)";
//			try (
//				Connection con = ds.getConnection(); 
//				PreparedStatement pstmt = con.prepareStatement(sql);
//			) {
...
//			DataSource ds = (DataSource) context.lookup(resource);
//			
//			String sql = "SELECT * FROM MemberHLab01";
//			try (
//				Connection con = ds.getConnection(); 
//				PreparedStatement pstmt = con.prepareStatement(sql);
...
//			DataSource ds = (DataSource) context.lookup(resource);
//			
//			String sql = "SELECT * FROM MemberHLab01 where pk = ?";
//			try (
//					Connection con = ds.getConnection(); 
//					PreparedStatement pstmt = con.prepareStatement(sql);
//				) {
...
//			DataSource ds = (DataSource) context.lookup(resource);
//			
//			String sql = "DELETE FROM MemberHLab01 WHERE pk = ?";
//			try (
//				Connection con = ds.getConnection(); 
//				PreparedStatement pstmt = con.prepareStatement(sql);
//			) {
...
//			DataSource ds = (DataSource) context.lookup(resource);
//			
//			String sql = "UPDATE MemberHLab01 SET id=?, pswd=?, name=? WHERE pk = ?";
//			try (
//				Connection con = ds.getConnection(); 
//				PreparedStatement pstmt = con.prepareStatement(sql);
//			) {
