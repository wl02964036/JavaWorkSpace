...
import ch04._00.dao.impl.MemberDaoImpl_WithLazyLoadingFilter;
import ch04._00.service.MemberService;
import ch04.ex01.model.Member;

public class MemberServiceImpl_WithLazyLoadingFilter implements MemberService {
    MemberDao dao;
	public MemberServiceImpl_WithLazyLoadingFilter() {
		dao = new MemberDaoImpl_WithLazyLoadingFilter();
	}
