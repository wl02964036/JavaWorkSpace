...
public class M2O_UNI_Merge_Main {
	...
	public static void main(String[] args) {
		...
		// 第一組：使用原來的老闆
		Employee empee = session.get(Employee.class, 3);
		Employer emper = empee.getEmployer();
		// 第二組：使用新建的老闆		
		Employee empee2 = session.get(Employee.class, 5);
		Employer emper2 = new Employer("張曉芳-新老闆");
