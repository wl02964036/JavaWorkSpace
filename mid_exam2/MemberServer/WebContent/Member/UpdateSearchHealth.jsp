    ...
    <form action="RegisterServlet" method="post" id="form1" onsubmit="return checkSubBtn();">
        <fieldset>
            ...
            <div class="divItem">
                ...
                <input type="text" name="empno" id="empno" maxlength="10" size="15" 
                value="<%=request.getParameter("empno")%>" readonly><span style="color: red;">(不可更改)</span>
            </div>
            <div class="divItem">
                <!--ename1-->
            ...
            <div class="divItem">
                ...
                <input type="hidden" value="<%= request.getParameter("gender")%>">
                <label>
                    <input type="radio" name="gender" id="sex1" value="male"<% if (request.getParameter("gender").equals("male")){out.print(" checked");} %>>男
                </label>
                <label>
                    <input type="radio" name="gender" id="sex2" value="female"<% if (request.getParameter("gender").equals("female")){out.print(" checked");} %>>女
                </label>
                <label>
                    <input type="radio" name="gender" id="sex3" value="other"<% if (request.getParameter("gender").equals("other")){out.print(" checked");} %>>其他
                </label>
            ...
            <div class="divItem">
                ...
                value="<%=request.getParameter("rocid1")%>">
            ...
            <div class="divItem">
                ...
                value="<%=request.getParameter("cname1")%>">
            ...
            <div class="divItem">
                ...
                value="<%=request.getParameter("account1")%>">
            ...
            <div class="divItem">
                ...
                value="<%=request.getParameter("pwd1")%>">
            ...
            <div class="divItem">
                ...
                value="<%=request.getParameter("pwd2")%>">
            ...
            <div class="divItem">
                ...
                value="<%=request.getParameter("phone1")%>">
                <label for="phone1">)</label>
            ...
            <div class="divItem">
                ...
                <input type="hidden" value="<%= request.getParameter("addr1")%>">
...
<!--                     </optgroup> -->
                ...
                value="<%=request.getParameter("addr2")%>">
                <label for="addr2">)</label>
                ...
                value="<%=request.getParameter("addr3")%>">
        ...
        <div class="sub">
            ...
            <input type="submit" class="btn" id="subBtn" name="updateSearchHealth" value="送出">
            <!-- &ensp; -->
    ...
    <script src="../js/UpdateSearchHealth.js"></script>
